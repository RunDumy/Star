...
from star_backend_flask.app import db
import unittest.mock as mock

# Add the star-backend directory to sys.path so star_backend_flask can be imported
sys.path.insert(0, str(Path(__file__).parent / 'star-backend'))
