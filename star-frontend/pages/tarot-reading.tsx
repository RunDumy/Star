...
const TarotReadingPage: NextPage = () => {
  return (
    <UniversalSpaceLayout currentPage="Tarot Oracle">
      <div className="min-h-screen py-8">
        ...
        <div className="fixed inset-0 pointer-events-none overflow-hidden">
          ...
          <div className="absolute top-3/4 right-1/4 w-1 h-1 bg-cosmic-light rounded-full opacity-40 animate-pulse animate-delay-1000"></div>
          <div className="absolute top-1/2 right-1/2 w-3 h-3 bg-cosmic-gold rounded-full opacity-20 animate-pulse animate-delay-2000"></div>
        </div>
      </div>
